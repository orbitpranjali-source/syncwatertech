          ...
          <div className="flex items-center justify-center gap-3 mb-10">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium border transition-colors ${
                filter === 'all' ? 'bg-[#0073bc] text-white border-[#0073bc]' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
              }`}
            >
              All Projects
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium border transition-colors ${
                filter === 'completed' ? 'bg-[#0073bc] text-white border-[#0073bc]' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
              }`}
            >
              Completed
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium border transition-colors ${
                filter === 'ongoing' ? 'bg-[#0073bc] text-white border-[#0073bc]' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
              }`}
            >
              Ongoing
            </button>
